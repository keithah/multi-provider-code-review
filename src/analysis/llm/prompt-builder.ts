...
export class PromptBuilder {
  ...
  build(pr: PRContext): string {
    ...
    instructions.push(
      ...
      '   - If it starts with "Consider", "Ensure that", "Monitor", "Verify" → NOT a bug',
      '',
      ...
      '   - NEVER flag: test implementation, mocks, coverage, structure',
      '',
      '3. DO NOT REVIEW WORKFLOW/CI FILES:',
      '   - Files: .github/workflows/*.yml, .github/actions/*, CI config',
      '   - DO NOT flag: fork PR security, secrets, concurrency, timeout config',
      '   - These are infrastructure, not application bugs',
      '',
      '4. DO NOT FLAG SUGGESTIONS AS ISSUES:',
      '   - "Consider adding", "Ensure that", "Monitor", "Verify" → NOT issues',
      '   - "Could be improved", "Should be", "Might want to" → NOT issues',
      ...
      '- Code structure suggestions (monolithic, should be split, etc.)',
      '',
