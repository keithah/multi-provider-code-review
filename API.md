...
| `COPILOT_TOKEN` | Token for GitHub Copilot-hosted models (optional) | _unset_ (uses `GITHUB_TOKEN` if provided) |
| `COPILOT_BASE_URL` | Base URL for Copilot chat completions | `https://models.inference.ai.azure.com` |
